...
A central personal project is [`fea_app`](https://github.com/RomanShushakov/fea_app), where I’ve been building a small finite-element–style analysis tool from scratch — not as a production FEA solver, but as a way to deeply understand:
